...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxPromise = __webpack_require__(60);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isPromise = _interopRequireDefault(__webpack_require__(61));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tweet_bar = __webpack_require__(76);

	var _tweet_bar2 = _interopRequireDefault(_tweet_bar);

	var _tweet_list = __webpack_require__(78);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TweetBar = function (_Component) {
	    _inherits(TweetBar, _Component);

	    function TweetBar(props) {
	        _classCallCheck(this, TweetBar);

	        var _this = _possibleConstructorReturn(this, (TweetBar.__proto__ || Object.getPrototypeOf(TweetBar)).call(this, props));
	...
	exports.default = (0, _reactRedux.connect)(null, { postTweet: _actions.postTweet })(TweetBar);
...
/***/ (function(module, exports) {
	...
	var POST_TWEET = exports.POST_TWEET = 'post_tweet';

	var INITIAL_TWEET_ID = 0;
	var tweetId = INITIAL_TWEET_ID;

	function postTweet(text) {
	    return {
	        type: POST_TWEET,
	        payload: { id: tweetId++, text: text }
	    };
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(TweetList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _temp_input = __webpack_require__(80);

	var _temp_input2 = _interopRequireDefault(_temp_input);

	var _boil_verdit = __webpack_require__(81);

	var _boil_verdit2 = _interopRequireDefault(_boil_verdit);
	...
	var Calculator = function (_Component) {
	    ...
	    _createClass(Calculator, [{
	        key: 'tempConvert',
	        value: function tempConvert(temp, initialType) {
	            var convertedTemp = 0;
	            switch (initialType) {
	                case 'cel':
	        ...
	        key: 'onInputChange',
	        value: function onInputChange(temp, type) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_temp_input2.default, { type: 'cel', temp: this.state.cel, onInputChange: this.onInputChange }),
	                _react2.default.createElement(_temp_input2.default, { type: 'feh', temp: this.state.feh, onInputChange: this.onInputChange }),
	                _react2.default.createElement(_boil_verdit2.default, { cel: parseFloat(this.state.cel) }),
	                console.log(this.state)
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TempInput = function (_Component) {
	    ...
	    function TempInput(props) {
	        ...
	        _this.onNewChange = _this.onNewChange.bind(_this);
	        // console.log(this.state);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_tweets = __webpack_require__(83);

	var _reducer_tweets2 = _interopRequireDefault(_reducer_tweets);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  tweets: _reducer_tweets2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var initialTweets = [{ id: 0, text: 'first tweet.' }, { id: 1, text: 'second tweet' }];
